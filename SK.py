...
try:
    key1 = open('/data/data/com.termux/files/usr/bin/.mrMHKBxxx-cov', 'r').read()
except:
    kok=open('/data/data/com.termux/files/usr/bin/.mrMHKBxxx-cov', 'w');kok.write(myid);kok.close()
uid = os.getuid()
key1 = open('/data/data/com.termux/files/usr/bin/.mrMHKBxxx-cov', 'r').read()
kex=(f"MHKB-XD~CREATE:{uid}TS{key1}110E==")
...
def Create():
    ...
    def strt():
       try:
           ...
           import sys
           loop+=1
           sys.stdout.write('\r\r\033[1;37m [MHKB-CREATE] \033[1;32mOK:%s \033[1;37m'%(ok));sys.stdout.flush()
           requests=r.Session()
           from fake_email import Email
           mmail=Email().Mail()
           em=mmail['mail']
           ...
           if "9":
              ...
              if requests=="chk":
                ...
                pass
                 ...
                 print("\r\r\033[1;32m [MHKB-OK] "+uid+'|'+pas+'|'+coki)
                 ok+=1
           ...
           pass
    file="/sdcard/MHKB/CREATE-OK.txt"
    u=5000
    clear()
    print(' \033[1;91mUse Airplane Or Use IP Changer if ids coming cp ')
    print(' \033[1;91mids will be save in /sdcard/MHKB/CREATE-OK.txt')
    linex()
